...
<body>
        ...
        <div class="container">
            <div class="row m-0">
                ...
                <div class="col-lg-9 col-md-9 d-none d-sm-none d-md-block pt-md-4" >
                    <div class="cover" style="border-radius: 5%;">
                        ...
                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_822_1758)">
                                <path
                                    ...
                                    stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="border-radius: 30%;"/>
                                <path
    ...
    <!-- End Category  -->
    <!-- Start Advertise  -->
    <div class="adver" style="border-radius: 30%;">
        <div class="container" style="border-radius: 30%;">
            <div class="cover" style="border-radius: 3%;">
                <span class="title">Categories</span>
