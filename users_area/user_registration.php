...
if (isset($_POST['user_register'])) {
    ...
    $mysqlif_user_password = $_POST['conf_user_password'];
    ...
    } else if ($user_password != $mysqlif_user_password) {
    ...
    // $select_cart_items_result = mysqli_query($mysqli,$select_cart_items);
