...
// $select_id_ip_rseult = mysqli_query($mysqli,$select_id_ip);
...
while($row_price=mysqli_fetch_array($cart_result)){
    ...
    $select_product_result = mysqli_query($mysqli,$select_product);
    ...
    $insert_pending_order_result = mysqli_query($mysqli,$insert_pending_order_query);
}
...
$insert_order_result = mysqli_query($mysqli,$insert_order_query);
...
$empty_cart_result = mysqli_query($mysqli,$empty_cart);
