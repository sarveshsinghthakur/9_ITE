...
if (isset($_GET['order_id'])) {
    ...
    $select_order_result = mysqli_query($mysqli,$select_order_query);
...
if(isset($_POST['confirm_payment'])){
    ...
    $insert_payment_result = mysqli_query($mysqli,$insert_payment_query);
    ...
    $update_orders_result = mysqli_query($mysqli,$update_orders_query);
}
?>
<!DOCTYPE html>
<html lang="en">
